...
|----------|-------------|-------------|
| Start My Day | `daily_digest` | `.paper-agent/daily/{YYYY-MM-DD}.md` |
| Paper Triage | `triage` | `.paper-agent/triage/{topic}-{YYYY-MM-DD}.md` |
| Paper Survey | `survey` | `.paper-agent/survey/{topic}.md` |
| Research Insight | `insight` | `.paper-agent/insight/{topic}-{YYYY-MM-DD}.md` |
| Paper Compare | `comparison` | `.paper-agent/compare/{title}-{YYYY-MM-DD}.md` |
| Paper Analyze | `analysis` | `.paper-agent/notes/{paper_id}.md` |
| Citation Explore | `citation_map` | `.paper-agent/citation-traces/{trace_name}.md` |
| Reading Pack | `reading_pack` | `.paper-agent/reading-packs/{question}.md` |
| Research Ideas | `ideation` | `.paper-agent/ideas/{topic}-ideas-{YYYY-MM-DD}.md` |
| Experiment Plan | `experiment_plan` | `.paper-agent/experiment-plans/{paper_id}-plan.md` |
| Search Results | `search_result` | `.paper-agent/search-results/{query}-{YYYY-MM-DD}.md` |
